"""KS1d windowed training with hard-IC ansatz and Jacobi GN."""
...
def main():
    ...
    default_data_path = repo_root / "data" / "ks_chaotic.mat"
    default_output_dir = repo_root / "runs" / "ks1d_gn"

    parser = argparse.ArgumentParser(description="KS1d windowed GN example")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--iterations", type=int, default=5000)
    parser.add_argument("--n_collocation", type=int, default=1000)
    ...
    for w in range(pde.n_windows):
        ...
        for i in range(1, args.iterations + 1):
            ...
            x_col = random.uniform(k2, (args.n_collocation,), minval=0.0, maxval=pde.L)
            params, loss = solver.step(params, t_col, x_col, 1e-12, stacked_past, w_idx)
